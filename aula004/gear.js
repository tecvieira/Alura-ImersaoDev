function jogar(){
    ...
    alert("Empate JOGADOR e COMPUTADOR escolheram número:" + escolhaComputador)
    }
    
    //-----------------------JOGADA 1 PEDRA------------------ 
    if(escolhaJogador == 1){
    if(escolhaComputador == 2){
        alert("Jogador PERDEU, escolheu PEDRA e o computador jogou número " + escolhaComputador + "- PAPEL" )
    }
    if(escolhaComputador == 3){
        alert("Jogador GANHOU escolheu PEDRA e o computador " + escolhaComputador + "TESOURA")
    }
    }
    //----------JOGADA 2 PAPEL--------
    if(escolhaJogador == 2){
